...
export const chip8InternalCpuActions = {
  ...
  randomBitwiseAnd: createStandardAction('chip8/opcode/RND_Vx_nn')<number>(),
  bitwiseXor: createStandardAction('chip8/opcode/XOR_Vx_Vy')<void>(),
  ...
  returnFromSubroutine: createStandardAction('chip8/opcode/RTS')<void>(),
